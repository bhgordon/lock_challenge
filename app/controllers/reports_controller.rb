...
class ReportsController < ApplicationController
  ...
  def handle
    ...
    render json: { message: "Your report has been processed. Now you have #{Lock.count} locks and #{Entry.count} entries" }
  end

  def authenticate_server
    # First we need to find the Server instance associated with the code_name that was
    # passed down to us in the first request
